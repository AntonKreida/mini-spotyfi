...
const PlayerController = () => (
  <div className="player__controls">
    ...
    <div className="player__btn-shuffle">
      <svg className='player__btn-shuffle-svg'viewBox="0 0 20 18">
